...
namespace ManageSystem.Resources.PasswordBoxWaterMark
{
    /// <summary>
    /// PasswordBox添加水印辅助类
    /// </summary>
    ...
    {
        public static string GetPassWordStr(DependencyObject obj)
        {
            return (string)obj.GetValue(PassWordStrProperty);
        }

        public static void SetPassWordStr(DependencyObject obj, string value)
        {
            obj.SetValue(PassWordStrProperty, value);
        }
    ...
    DependencyProperty.RegisterAttached("PassWordStr", typeof(string), typeof(PasswordBoxWaterMark), new PropertyMetadata(""));
