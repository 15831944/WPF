   ...
   public  class SignAnomalyStatViewModel : NotificationObject
    {
        ...
        public SignAnomalyStatViewModel()
        {
            ...
            _bShowChart                                 = ShowChartEnum.ShowChartEnum_Pie;
        ...
        string MakeStatisticsQuerySql(object obj)
        {
            ...
            {
                strCondition += " ( ";
                strCondition += "select count(*) as totalCnt from Shebeiyichangshuju where Xuhao>=-1";
                strCondition +=  MakeDeviceConditionSql("Shebeiyichangshuju");
                strCondition += " and Shebeiyichangshuju.[Riqi]>=" + Common.ConvertDateTimeInt(realstartTime);
                ...
                if (realstartTime < realendTime)
                    ...
                    strCondition             += " and Shebeiyichangshuju.[Riqi]<" + Common.ConvertDateTimeInt(realendTime);
        ...
        public void ResizeShowCharts()
        {
            ...
            if(mainModel.bShowPage == PageVisibleEnum.PageVisibleEnum_SignAnomalyStat)
            {
