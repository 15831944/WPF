...
namespace ManageSystem.ViewModel
{
    class SignAnomalyStatViewModel : NotificationObject
    {
        ...
        string MakeBenyuebanliyewuCurMonthQuerySql(object obj, DateTime BeginTime)
        {
            ...
            str += "select count(*) as totalCnt from Shebeiyichangshuju where Xuhao>=-1";
            str += " and Shebeiyichangshuju.[Riqi]>=" + Common.ConvertDateTimeInt(Common.FirstDayOfMonth(BeginTime));
            str += " and Shebeiyichangshuju.[Riqi]<=" + Common.ConvertDateTimeInt(Common.LastDayOfMonth(BeginTime));
