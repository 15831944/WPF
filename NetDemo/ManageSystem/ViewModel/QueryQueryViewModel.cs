   ...
   public  class QueryQueryViewModel : NotificationObject
    {
        ...
        public ObservableCollection<CHAXUNSHUJUModel> _tableListTemp = new ObservableCollection<CHAXUNSHUJUModel>();
        ...
        public void ShowPage(int pageindex)
        {
            App.Current.Dispatcher.BeginInvoke(new Action(() =>
            {
                if (numofpage > 0)
                {
                    ...
                    tableList = new ObservableCollection<CHAXUNSHUJUModel>(_tableListTemp.Take(numofpage * pageindex).Skip(numofpage * (pageindex - 1)).ToList());   //刷选第currentSize页要显示的记录集  
