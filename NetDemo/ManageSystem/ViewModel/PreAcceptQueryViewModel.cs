...
namespace ManageSystem.ViewModel
{
    ...
    {
        public QueryYUSHOULISHUJUCallBackDelegate       _queryyushoulishujucallbackdelegate = null;
        ...
        {
            _queryyushoulishujucallbackdelegate         = new Server.QueryYUSHOULISHUJUCallBackDelegate(QueryYUSHOULISHUJUCallBack);
        ...
        public void DG1_AutoGeneratingColumn(object sender, DataGridAutoGeneratingColumnEventArgs e)
        {
            ...
            else if (headername == "Chuguoshiyou")
            {
                e.Column.Header = "出国事由";
            }
            ...
            else if (headername == "Xingbie")
            {
                e.Column.Header = "性别";
            }
            else if (headername == "Hukousuozaidi")
            {
                e.Column.Header = "户口所在地";
            }
            else if (headername == "Minzu")
            {
                e.Column.Header = "民族";
            }
        }
   
        public void QueryYUSHOULISHUJUCallBack(
                int Xuhao,
                string Riqi,
                string ShebeiIP,
                string Yewubianhao,
        ...
        {
            tableList.Clear();
            WorkServer.GetInstance().QueryYUSHOULISHUJU("select * from Yushoulishuju", Marshal.GetFunctionPointerForDelegate(_queryyushoulishujucallbackdelegate));
        }
