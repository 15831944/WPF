   ...
   public  class PreAcceptQueryViewModel : NotificationObject
    {
        ...
        public ObservableCollection<YUSHOULISHUJUModel> _tableListTemp = new ObservableCollection<YUSHOULISHUJUModel>();
        ...
        public void ShowPage(int pageindex)
        {
            App.Current.Dispatcher.BeginInvoke(new Action(() =>
            {
                if (numofpage > 0)
                {
                    ...
                    tableList = new ObservableCollection<YUSHOULISHUJUModel>(_tableListTemp.Take(numofpage * pageindex).Skip(numofpage * (pageindex - 1)).ToList());   //刷选第currentSize页要显示的记录集  
        ...
        string MakeQuerySql(object obj)
        {
            ...
            string tableName = "Yushoulishuju";
            bool bSel0 = false;
